    ...
    **kwargs,
    ...
    for dataset_dict in tqdm(dataset_names_dict, desc="Combining datasets..."):
        with accelerator.local_main_process_first():
            try:
                dataset = datasets.load_from_disk(dataset_dict["name"])
            ...
            if metadata_dataset_name is not None:
                ...
                try:
                    metadata_dataset = datasets.load_from_disk(metadata_dataset_name)
                except FileNotFoundError:
                ...
                if isinstance(metadata_dataset, datasets.DatasetDict):
                    metadata_dataset = metadata_dataset[dataset_dict["split"]]
